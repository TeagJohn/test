...
public class SubUnionDataNode extends UnionDataNode implements IConstructorExpanableDataNode {

    private static final AkaLogger logger = AkaLogger.get(SubUnionDataNode.class);
