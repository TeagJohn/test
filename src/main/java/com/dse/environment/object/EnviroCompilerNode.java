...
public class EnviroCompilerNode extends AbstractEnvironmentNode {
    ...
    public String exportToFile() {
        ...
        output += ENVIRO_COMPILER_IS_CMAKE_PROJECT + " " + isCMakeProject + SpecialCharacter.LINE_BREAK;
        output += ENVIRO_COMPILER_CMAKE_GENERATOR + " " + cmakeGenerator + SpecialCharacter.LINE_BREAK;
