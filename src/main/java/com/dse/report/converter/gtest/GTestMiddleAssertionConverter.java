...
public class GTestMiddleAssertionConverter extends GTestAssertionConverter {
    private int iterator;

    public GTestMiddleAssertionConverter(List<IResultTrace> failures, int fcalls, int iterator) {
