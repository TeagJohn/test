...
public class GTestInitialAssertionConverter extends GTestAssertionConverter {

    public GTestInitialAssertionConverter(List<IResultTrace> failures, int fcalls) {
