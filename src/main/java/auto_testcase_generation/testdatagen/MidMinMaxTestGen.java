...
//                tasks.add(task);
    ...
    protected synchronized TestCase createTestcase(int iteration, ICommonFunctionNode functionNode) {
        ...
        String nameofTestcase = TestCaseManager.generateContinuousNameOfTestcase(TestCaseManager.getFunctionName(functionNode) + tail);
    ...
    private class testCaseGenerator implements Callable<String> {
        ...
        private void genRandValue(String originalName, String type, IVariableNode arguments, IFunctionConfigBound b, List<RandomValue> randomValues, boolean isStruct) {
            if (b instanceof MultiplePrimitiveBound) {
                MultiplePrimitiveBound multipleBound = (MultiplePrimitiveBound) b;
                PrimitiveBound lowerBound = multipleBound.get(0);
                PrimitiveBound upperBound = multipleBound.get(multipleBound.size() - 1);
                b = new PrimitiveBound(lowerBound.getLower(), upperBound.getUpper());
            }
